/* Vendored from @thyrith/momentkh v3.0.3 — MIT License (c) Thyrith Sor.
   https://github.com/ThyrithSor/momentkh — zero-dependency Khmer lunar calendar.
   Copied into repo (not git-installed) for deploy stability + code review. */
